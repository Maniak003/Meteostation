...
void secToDate(tstamp seconds) {
	struct tm *ttm;
	ttm = gmtime(&seconds);
	Nowdatetime.yy = ttm->tm_year;
	Nowdatetime.mo = ttm->tm_mon;
	Nowdatetime.dd = ttm->tm_mday;
	Nowdatetime.hh = ttm->tm_hour;
	Nowdatetime.mm = ttm->tm_min;
	Nowdatetime.ss = ttm->tm_sec;
}
